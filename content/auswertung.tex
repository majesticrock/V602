...
\subsection{Das Emmissionsspektrum von Kupfer}
    ...
    \subsubsection{Bestimmung der Abschirmkonstante}
        ...
        \centerline{$\sigma_3 = z - 2 \sqrt{\frac{R_{\infty}(z - \sigma_1)^2 - E_{\symup{\beta}}}{R_{\infty}}} = 28.57$.}
        \\ \\
        Bei der Bestimmung von $\sigma_3$ wird ein kleinstmöglicher Fehler von $22$eV von $E_{\symup{\beta}}$ abgezogen, da der Wurzelterm sonst 
        negativ ist und nicht sinnvoll bestimmbar wäre.
